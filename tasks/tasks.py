...
def mine(self, data):
    ...
    driver = webdriver.Remote(command_executor='http://seleniumhub:4444/wd/hub', desired_capabilities=DesiredCapabilities.CHROME)
    links = list()
    content = list()
    while True:
        #try:
        ...
        if not soup.find(price_container_tag, class_=price_container_class) or\
        ...
        #    driver.quit()
        #    driver = webdriver.Remote(command_executor='http://seleniumhub:4444/wd/hub',
